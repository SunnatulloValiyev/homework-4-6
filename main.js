...
// function max_num(number1, number2) {
//     if(number1 > number2){
//         console.log(`birinchi son kotta ${number1}`);
//     }
//     else if (number2 > number1) {
//         console.log(`ikkinchi son kotta ${number2}`);
//     } else {
//         console.log(`ikkala son teng ${number1} = ${number2}`);        
//     }
// }
